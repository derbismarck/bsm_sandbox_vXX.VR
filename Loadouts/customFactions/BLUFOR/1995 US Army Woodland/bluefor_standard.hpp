...
// ====================================================================================
    ...
    class Tank {
        TransportWeapons[] = {WEST_CARBINE,WEST_CARBINE,WEST_CARBINE};
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_Wood_A","MNP_CombatUniform_Wood_B"};  /// randomized
        vest[] = {"LOP_V_CarrierLite_WDL","LOP_V_CarrierRig_WDL"}; /// randomized
        headgear[] = {"MNP_Helmet_PAGST_M81"}; /// randomized
        backpack[] = {"TAC_BP_LBT_HB_OD","TRYK_B_Belt","TAC_BP_HSG_AB_OD",""}; /// randomized
        backpackItems[] = {};
        weapons[] = {WEST_RIFLE}; /// randomized
        launchers[] = {}; /// randomized
        handguns[] = {}; /// randomized
        magazines[] = {WEST_RIFLE_MAG,WEST_GRENADE,WEST_SMOKE_WHITE};
        items[] = {"ACRE_PRC343","ACE_fieldDressing:3","ACE_morphine"};
    ...
    class B_officer_F: B_Soldier_F {// CO and DC
        ...
        vest[] = {"LOP_V_CarrierLite_WDL","LOP_V_CarrierRig_WDL"}; /// randomized
        headgear[] = {"MNP_Helmet_PAGST_M81"}; /// randomized
		backpack[] = {"TRYK_B_Belt"}; /// randomized
    ...
    class B_soldier_UAV_F: B_Soldier_F {
        backpack[] = {"MNP_B_WD_CA"}; /// randomized
	...
	class B_medic_F: B_Soldier_F {// Medic
        vest[] = {"LOP_V_CarrierLite_WDL","LOP_V_CarrierRig_WDL"}; /// randomized
        weapons[] = {WEST_RIFLE};
        magazines[] = {WEST_RIFLE_MAG,WEST_SMOKE_WHITE};
...
// Vehicle Infantry
    ...
    class B_crew_F {// Crew
        uniform[] = {"MNP_CombatUniform_Wood_A"};  // randomized
        vest[] = {"LOP_V_CarrierLite_WDL"}; // randomized
        headgear[] = {"H_HelmetCrew_I"}; /// randomized
        backpack[] = {"TRYK_B_Belt","TAC_BP_HSG_AB_OD",""}; /// randomized
        weapons[] = {}; /// randomized
        magazines[] = {WEST_PISTOL_MAG,WEST_SMOKE_WHITE};
		handguns[] = {WEST_PISTOL}; /// randomized
        items[] = {"ACE_fieldDressing:3","ACE_morphine","ACE_key_west","ACRE_PRC148","ACRE_PRC117F"};
        backpackItems[] += {};
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemGPS"};
    };
