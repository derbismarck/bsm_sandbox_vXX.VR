...
class blu_f {
	...
	//Rifle
    #define WEST_RIFLE "CUP_arifle_G36A"
	...
	//Carbine
    #define WEST_CARBINE "CUP_arifle_G36C"
   ...
   // AR
	...
	// MAT
    #define WEST_MAT "CUP_launch_MAAWS"
    #define WEST_MAT_MAG "CUP_MAAWS_HEAT_M:3","CUP_MAAWS_HEDP_M:3"
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_Germany_S"};  /// randomized
        vest[] = {"MNP_Vest_Germany_2"}; /// randomized
        headgear[] = {"TRYK_H_PASGT_COYO","MNP_Boonie_GER_T"}; /// randomized
        backpack[] = {"TRYK_B_Belt_AOR1"}; /// randomized
