...
class blu_f {
	...
	//Rifle
    #define WEST_RIFLE "hlc_rifle_bcmjack"
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_Germany_SD"};  /// randomized
        vest[] = {"MNP_Vest_Germany_D"}; /// randomized
        headgear[] = {"H_HelmetB_light_sand","MNP_Boonie_GER_D"}; /// randomized
