...
class blu_f {
    ...
    #define WEST_RIFLE_MAG "hlc_30Rnd_545x39_B_AK:10"

	//GL Rifle
    #define WEST_GLRIFLE "hlc_rifle_ak12GL"
    #define WEST_GLRIFLE_MAG "hlc_30Rnd_545x39_B_AK:10"
    #define WEST_GLRIFLE_MAG_SMOKE "hlc_GRD_White:4","hlc_GRD_green:2","hlc_GRD_Red:3"
    #define WEST_GLRIFLE_MAG_HE "hlc_VOG25_AK:8"
    #define WEST_GLRIFLE_MAG_FLARE "UGL_FlareRed_F:0","UGL_FlareGreen_F:0"

	//Carbine
    #define WEST_CARBINE "hlc_rifle_ak12"
    #define WEST_CARBINE_MAG "hlc_30Rnd_545x39_B_AK:10"
    ...
    #define WEST_AR_MAG "hlc_45Rnd_545x39_t_rpk:6"
    #define WEST_AR_MAG2 "hlc_45Rnd_545x39_t_rpk:6"
...
// Leadership INF and Groupies
    ...
    class B_Soldier_F {// rifleman
        uniform[] = {"MNP_CombatUniform_Fin_A","MNP_CombatUniform_Fin_B"};  /// randomized
        vest[] = {"MNP_Vest_FIN_1","MNP_Vest_FIN_2"}; /// randomized
        headgear[] = {"MNP_Boonie_FIN","MNP_Helmet_FIN_T"}; /// randomized
