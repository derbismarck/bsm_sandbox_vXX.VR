...
class opf_f {
    //Rifle
    #define EAST_RIFLE "rhs_weap_ak74m_plummag"
    ...
    #define EAST_GLRIFLE_MAG_SMOKE "rhs_GRD40_White:2","rhs_GRD40_Green:1","rhs_GRD40_Red:2"
    #define EAST_GLRIFLE_MAG_HE "rhs_VOG25:6"
    #define EAST_GLRIFLE_MAG_FLARE "UGL_FlareWhite_F:0"
    
	//Carbine
    #define EAST_CARBINE "rhs_weap_ak74m_plummag"
    #define EAST_CARBINE_MAG "rhs_30Rnd_545x39_AK:8"
    
	// AR
    #define EAST_AR "rhs_weap_pkm"
    #define EAST_AR_MAG "rhs_100Rnd_762x54mmR:4"
    #define EAST_AR_MAG2 "rhs_100Rnd_762x54mmR_green:3"
    ...
    #define EAST_SMOKE_WHITE ""
    #define EAST_SMOKE_GREEN ""
    #define EAST_SMOKE_RED ""
...
// Leadership INF and Groupies
    ...
    class O_Soldier_F { // rifleman
        uniform[] = {"TRYK_U_B_Woodland_Tshirt","TRYK_U_B_Woodland"};  /// randomized
        vest[] = {"V_TacVest_camo"}; /// randomized
        headgear[] = {"rhs_6b27m_green","rhs_6b27m_green_ess"}; /// randomized
        backpack[] = {"rhs_sidor","rhs_assault_umbts"}; /// randomized
	...
	class O_medic_F: O_Soldier_F {// Medic
        vest[] = {"TRYK_B_Medbag_OD"}; /// randomized
