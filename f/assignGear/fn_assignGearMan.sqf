waitUntil {!isNil "bsmrk_param_bluforFaction"};
...
_side = switch (side _unit) do {
    case west: {["BLUFOR_", bsm_param_bluforFaction]};
    case east: {["OPFOR_", bsm_param_opforFaction]};
    case resistance: {["INDFOR_", bsm_param_indFaction]};
};
